...
public class HospedagemEU {
    ...
    public HospedagemEU(String nomeHotel, String localizacao, LocalDate checkin, LocalDate checkout, float diasEstadia, double precoDiaria) {
